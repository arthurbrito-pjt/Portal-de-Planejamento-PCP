...
export const INITIAL_FERRAMENTAL: Ferramental[] = [
  ...
  {
    // Corrigido: SLT11050 no catálogo oficial é "100 x 50 x 1,80MM" (blank 191).
    // O código correto para "100 x 50 x 17 x 2,00MM" é SLT11145 (blank 215).
    id: 'FRM_SLT11145',
    codigo: 'SLT11145',
  ...
  {
    // Corrigido: SLT11065 no catálogo oficial é "127 x 50 x 17 x 1,80MM" (blank 237).
    // O código correto para "127 x 50 x 17 x 2,65MM" é SLT11335 (blank 236).
    id: 'FRM_SLT11335',
    codigo: 'SLT11335',
    nome: 'SLITTER 127 x 50 x 17 x 2,65MM',
    classe: 'C',
    familia: 'PERFIL',
    larguraFita: 236.0,
    espessura: 2.65,
  ...
  {
    // Corrigido: SLT11370 no catálogo oficial é "50 x 25 x 10 x 3,00MM" (blank 101),
    // incompatível com a descrição de uso (chapa pesada 4,75mm). O código correto
    // para "200 x 75 x 25 x 4,75MM" é SLT11500 (blank 356).
    id: 'FRM_SLT11500',
    codigo: 'SLT11500',
